  ...
  $(document).ready(function() {
    ...
    */
    ...
    if ($('#summernote').length) {
	  ...
	  $('#summermin').summernote({
        height: 100,
        focus: true,
        toolbar: [['style', ['style']], ['style', ['bold', 'italic', 'underline', 'clear']], ['fontsize', ['fontsize']], ['color', ['color']], ['para', ['ul', 'ol', 'paragraph']], ['height', ['height']]]
      });
    }
    /*
    # =============================================================================
    ...
    */
    ...
    if ($('.typeahead').length) {
		var uri = base_url + "ajax/get-patient-name";
		...
		$.ajax({
			...
			success: function(msg) {
				...
				$("#patient_search").css("min-width", "355px");
...
//	 }, 3000);
    ...
    $.ajax({
      type: "GET",
      dataType: "html",
      url: "http://internalmedia.net/cron.php" ,
      success: function(msg) { }
    }); 
	}
...
function count_emergency() {
	var uri = base_url + "ajax/count-emergency";
	...
	$.ajax({
		...
		url: uri ,
		success: function(msg) {
			$("#count_emergency").html(msg);                                                                      
		}
	}); 
}

function notif_emergency() {
	var uri = base_url + "ajax/notif-emergency";
	...
	$.ajax({
		...
		url: uri ,
		success: function(msg) {
			$("#notif_emergency").html(msg);                                                                      
		}
	}); 
}

function count_nonemergency() {
	var uri = base_url + "ajax/count-nonemergency";
	...
	$.ajax({
		...
		url: uri ,
		success: function(msg) {
			$("#count_nonemergency").html(msg);                                                                      
		}
	}); 
}

function notif_nonemergency() {
	var uri = base_url + "ajax/notif-nonemergency";
