				...
				<div class="widget-container fluid-height clearfix">
					...
					<div class="widget-content padded clearfix">
						...
						<div class="form-group">
							...
							<div class="col-md-10">	
								<textarea class="form-control" rows="2" style="resize: none;" readonly><?php echo strip_tags($row->nonemergency_requestnote); ?></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-6">
				...
				<div class="widget-container fluid-height clearfix">
					<div class="widget-content padded clearfix">
						<div class="row">
							<center>
								<a class="btn btn-warning" href="javascript:void(0);">Depart Scene <br /><?php echo (($row->time_to_patient == "")?"-":convert_to_dmy($row->time_to_patient)); ?><br /><?php echo (($row->time_to_patient == "")?"00:00:00":convert_to_his($row->time_to_patient)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">RMO Call Scene <br /><?php echo (($row->time_call_patient == "")?"-":convert_to_dmy($row->time_call_patient)); ?><br /><?php echo (($row->time_call_patient == "")?"00:00:00":convert_to_his($row->time_call_patient)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">Arrival at Scene <br /><?php echo (($row->time_arrived_patient == "")?"-":convert_to_dmy($row->time_arrived_patient)); ?><br /><?php echo (($row->time_arrived_patient == "")?"00:00:00":convert_to_his($row->time_arrived_patient)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">Depat to Hospital <br /><?php echo (($row->time_to_hospital == "")?"-":convert_to_dmy($row->time_to_hospital)); ?><br /><?php echo (($row->time_to_hospital == "")?"00:00:00":convert_to_his($row->time_to_hospital)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">Arrival at Hospital <br /><?php echo (($row->time_arrived_hospital == "")?"-":convert_to_dmy($row->time_arrived_hospital)); ?><br /><?php echo (($row->time_arrived_hospital == "")?"00:00:00":convert_to_his($row->time_arrived_hospital)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">Depart to Base Hospital <br /><?php echo (($row->time_back_hospital == "")?"-":convert_to_dmy($row->time_back_hospital)); ?><br /><?php echo (($row->time_back_hospital == "")?"00:00:00":convert_to_his($row->time_back_hospital)); ?></a>
								<a class="btn btn-warning" href="javascript:void(0);">Arrival at Base Hospital <br /><?php echo (($row->time_complete == "")?"-":convert_to_dmy($row->time_complete)); ?><br /><?php echo (($row->time_complete == "")?"00:00:00":convert_to_his($row->time_complete)); ?></a>
							</center>
						</div>
					</div>
				</div>
