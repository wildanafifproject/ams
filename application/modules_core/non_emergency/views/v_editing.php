<div class="container-fluid main-content">
    <div class="row">
		...
		<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>non-emergency/updating-data">
			<input type="hidden" name="valid" value="<?php echo simple_encrypt(1); ?>" readonly />
			<input type="hidden" id="date" value="<?php echo $row->nonemergency_infodate; ?>" />
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<div class="input-group date datepicker" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
									<input class="form-control" name="date" type="text" value="<?php echo (($row->nonemergency_infodate == "")?get_ymd():convert_to_dmy($row->nonemergency_infodate)); ?>" autocomplete="off" required="" ><span class="input-group-addon"><i class="icon-calendar"></i></span></input>
								</div>
							</div>
						</div>
						<div class="form-group">
			...
			<div class="col-lg-6">
				...
				<div class="widget-container fluid-height clearfix">
					<div class="widget-content padded clearfix">
						<div class="row">
							<center>
								<a class="btn btn-danger" href="javascript:void(0);" OnClick="show_form_cancel_nonemergency('<?php echo simple_encrypt($row->nonemergency_id); ?>');"><i class="icon-trash"></i> CANCEL ORDER</a>
								<button type="reset" class="btn btn-danger"><i class="icon-repeat"></i> RESET</button>
								<a class="btn btn-warning" href="javascript:void(0);" OnClick="accept_nonemergency('<?php echo simple_encrypt($row->nonemergency_id); ?>');"><i class="icon-check"></i> ACCEPT</a>
