    ...
    <div class="row">
		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				<div class="heading">
					EDIT NURSES
					<a href="javascript:void(0);" OnClick="link_to('master/nurse');"><i class="icon-arrow-left pull-right"> Back</i></a>
				</div>
				<div class="widget-content padded clearfix">
					<?php foreach($detail as $row) : ?>
					<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>master/nurse/update-data" enctype="multipart/form-data">
						<input type="hidden" name="valid" value="<?php echo simple_encrypt(1); ?>" />
						<input type="hidden" name="id" value="<?php echo simple_encrypt($row->nurse_id); ?>" />
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="toggle-switch text-toggle-switch" data-off-label="<?php echo get_status(0); ?>" data-on="primary" data-on-label="<?php echo get_status(1); ?>" style="width:175px;">
									<input value="1" name="status" <?php echo (($row->nurse_status == 1)?"Checked":""); ?> type="checkbox" />
								</div>	
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="form-control" id="code" name="code" type="text" value="<?php echo $row->nurse_code; ?>" autocomplete="off" required="" minlength="3" maxlength="25" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2">Name <span class="text-danger">*</span></label>
							<div class="col-md-9">
								<input class="form-control" id="name" name="name" type="text" value="<?php echo strip_tags($row->nurse_name); ?>" autocomplete="off" required="" minlength="3" maxlength="255" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2">Phone <span class="text-danger">*</span></label>
							<div class="col-md-3">
								<input class="form-control" id="phone" name="phone" type="text" value="<?php echo $row->nurse_phone; ?>" autocomplete="off" required="" minlength="3" maxlength="255" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2">Address</label>
							<div class="col-md-9">
								<textarea class="form-control" rows="2" style="resize: none;" id="address" name="address"><?php echo strip_tags($row->nurse_address); ?></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="fileupload fileupload-new" data-provides="fileupload">
									<div class="fileupload-new img-thumbnail" style="width: 150px; height: 150px;">
										<img src="<?php echo base_url() ."assets/uploads/".(($row->nurse_image != "")?"nurse/thumb/". $row->nurse_image:"no_image.png"); ?>" style="width: 150px; max-height: 150px" />
									</div>
