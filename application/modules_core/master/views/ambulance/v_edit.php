    ...
    <div class="row">
		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				<div class="heading">
					EDIT AMBULANCE
					<a href="javascript:void(0);" OnClick="link_to('master/ambulance');"><i class="icon-arrow-left pull-right"> Back</i></a>
				</div>
				<div class="widget-content padded clearfix">
					...
					<div class="tab-content padded" id="my-tab-content">
						<div class="tab-pane active" id="tab1">
							...
							<form id="validate-name" class="form-horizontal" method="post" action="<?php echo base_url(); ?>master/ambulance/update-data" enctype="multipart/form-data">
								<input type="hidden" name="valid" value="<?php echo simple_encrypt(1); ?>" />
								<input type="hidden" name="id" value="<?php echo simple_encrypt($row->ambulance_id); ?>" />
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input class="form-control" id="code" name="code" type="text" value="<?php echo $row->ambulance_no; ?>" autocomplete="off" required="" minlength="1" maxlength="10" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-2">Police No. <span class="text-danger">*</span></label>
									<div class="col-md-3">
										<input class="form-control" id="plat" name="plat" type="text" value="<?php echo $row->ambulance_police; ?>" autocomplete="off" required="" minlength="5" maxlength="20" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
										<select class="select2able" name="status">
											<?php for($i=0; $i<=2; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php echo (($i == $row->ambulance_status)?"Selected":""); ?>><?php echo get_ambulance($i); ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
									...
									<div class="col-md-9">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new img-thumbnail" style="width: 150px; height: 150px;">
												<img src="<?php echo base_url() ."assets/uploads/".(($row->ambulance_image != "")?"ambulance/thumb/". $row->ambulance_image:"no_image.png"); ?>" style="width: 150px; max-height: 150px" />
											</div>
						...
						<div class="tab-pane" id="tab2">
							<?php foreach($detail as $row) : ?>
							<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>master/ambulance/update-password">
								<input type="hidden" name="valid" value="<?php echo simple_encrypt(1); ?>" />
								<input type="hidden" name="id" value="<?php echo simple_encrypt($row->ambulance_id); ?>" />
								<div class="form-group">
									<label class="control-label col-md-2">Username</label>
									<div class="col-md-4">
										<input class="form-control" type="text" value="<?php echo $row->ambulance_username; ?>" readonly />
									</div>
								</div>
								<div class="form-group">
