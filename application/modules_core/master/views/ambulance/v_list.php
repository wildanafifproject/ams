    ...
    <div class="row">
		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				<div class="heading">
					LIST AMBULANCE
					<a href="javascript:void(0);" OnClick="link_add('master/ambulance');"><i class="icon-plus pull-right"> Add Data</i></a>
				</div>
					...
					<table class="table table-bordered table-striped" id="dataTableNoSort">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center" class="hidden-xs"><?php echo $row->ambulance_username; ?></td>
								<td align="center">
									<span class="label label-<?php echo get_color($row->ambulance_status); ?>"><?php echo get_ambulance($row->ambulance_status); ?></span>
								</td>
								<td class="actions" align="center">
									<div class="action-buttons">
										<a class="table-actions" href="javascript:void(0);" onClick="edit_data('master/ambulance', '<?php echo simple_encrypt($row->ambulance_id); ?>');"><i class="icon-pencil"></i></a>
									</div>
								</td>
							</tr>
							<?php endforeach; ?>
