		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				...
				<div class="widget-content padded clearfix">
					<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>master/ambulance/insert-data" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input class="form-control" id="plat" name="plat" type="text" value="<?php echo (($this->session->flashdata('plat') == "")?"":$this->session->flashdata('plat')); ?>" autocomplete="off" required="" minlength="5" maxlength="20" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="control-label col-md-2">No. Kartu <span class="text-danger">*</span></label>
							<div class="col-md-4">
								<input class="form-control"  name="no_kartu" type="text" autocomplete="off" required="" minlength="5" maxlength="25" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2">Imei <span class="text-danger">*</span></label>
							<div class="col-md-4">
								<input class="form-control"  name="imei" type="text" autocomplete="off" required="" minlength="5" maxlength="25" />
							</div>
						</div>
						<div class="form-group">
