		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				...
				<div class="widget-content padded clearfix">
					<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>setting/sub-category/insert-data">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select class="select2able" name="category" required="">
									...
									<option value="<?php echo $rw->category_id; ?>"><?php echo strip_tags($rw->category_name); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
