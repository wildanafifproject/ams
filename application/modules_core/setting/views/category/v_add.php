		...
		<div class="col-lg-10">
			<div class="widget-container fluid-height clearfix">
				...
				<div class="widget-content padded clearfix">
					<form id="validate-form" class="form-horizontal" method="post" action="<?php echo base_url(); ?>setting/category/insert-data">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<label class="checkbox"><input type="checkbox" name="check" value="1" Checked /><span>Emeregency</span></label>
							</div>
						</div>
						<div class="social-login clearfix"></div>
						<div class="form-group">
